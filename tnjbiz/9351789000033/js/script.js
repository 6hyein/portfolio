document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        ...
        form.addEventListener('submit', (e) => {
            ...
            // 연매출 (select 태그로 신규 추가됨)
            const annualSales = form.querySelector('select[name="annual_sales"]');
            if (annualSales && annualSales.value) {
                M_data += " / 연매출: " + annualSales.value;
            }
